...
local sVersion = '1.1';
local rVersion = GetWebResult('raw.githubusercontent.com', '/pvpsuite/BoL/master/Versions/Scripts/p_inSec.version?no-cache=' .. math.random(1, 25000));
...
if ((rVersion) and (tonumber(rVersion) ~= nil)) then
	...
	print('<font color="#FF1493"><b>[p_inSec]</b> </font><font color="#FF0000">Update Error</font>');
end;
